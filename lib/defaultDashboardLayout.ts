...
export const DEFAULT_WIDGET_LAYOUTS: ResponsiveDashboardLayouts = {
  lg: [
    { i: 'portfolio-graph', x: 0, y: 0, w: 7, h: 5, minW: 4, minH: 3, maxW: 12, maxH: 8, visible: true },
    { i: 'account-summary', x: 7, y: 0, w: 5, h: 5, minW: 3, minH: 3, maxW: 12, maxH: 7, visible: true },
  ...
  md: [
    { i: 'portfolio-graph', x: 0, y: 0, w: 6, h: 5, minW: 4, minH: 3, maxW: 10, maxH: 8, visible: true },
    { i: 'account-summary', x: 6, y: 0, w: 4, h: 5, minW: 3, minH: 3, maxW: 10, maxH: 7, visible: true },
